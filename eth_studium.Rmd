...
<!---- 
## To Do ETH+UNSW Studium
- Post summaries from my ETH lectures
Include organisation and planning tips (one .ppx slide per paper, journaling, A5 paper list, Success plan, reading papers about topics not closely related to PhD (Vikings in NA, rabbit travels, sea ice bridge St. Lawrence, dinosaur extinction), ...)
- Post HBR summary docs
- Include LaTeX report template with link to overleaf
